...
> 🐾 **З чого почати:** [**«Підключити агента»**](https://sergiush-ua.github.io/nyshporka/agent/) —
> покрокова інструкція без термінала: Claude Desktop або Codex, три програми в
> правильному порядку й один готовий запит, після якого агент сам усе ставить
> і питає, яке прізвище шукаємо. Це не для чатів на сайті — чат не має доступу
> до ваших сканів; для агента, що працює на вашому комп'ютері.
...
не виставляють), зведений покажчик Duck Inspector і каталог книг за селом
ridni.org — за спільним контрактом джерела: `search` / `browse` /
...
**Друковане: Чтиво.** Архівна копія е-бібліотеки chtyvo.org.ua на shron.org
