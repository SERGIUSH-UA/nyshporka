...
* **Зразкової справи немає.** Готовність машини перевіряє окремий екран
  («Перевірити цю машину», він же `nysh doctor`): він каже, чого бракує і чим
  це ставиться. Але прогнати справжнє читання на вкладеному прикладі поки
  нічим — а хотілося б саме до того, як людина вкладе три тисячі сканів.
