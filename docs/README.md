...
| що це за застосунок | [`../README.md`](../README.md) |
| **поставити**: важелі, набори частин, деінсталяція | [`install.md`](install.md) |
| що вже працює, з межами кожного джерела | [`features.md`](features.md) |
| **чого ще немає**, без замовчувань | [`limits.md`](limits.md) |
| підписування інсталятора, ліцензії, приватність | [`signing.md`](signing.md) |
