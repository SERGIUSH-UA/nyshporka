...
> Технічний довідник можливостей: команди, джерела, заміри. Для помічника й
> для того, хто хоче знати подробиці. Людині простими словами —
> [«Як працювати»](../start.md).
...
[`docs/agents/`](first-session.md): що вміє, **чого не вміє**, як читати нуль,
...
## Межі: чого ще немає { #mezhi-chogo-shche-nemaie }
