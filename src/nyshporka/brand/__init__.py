...
Нишпорка — куниця з лупою, яка приносить знайдене з архіву: лапка на знаку —
слід у справі, лупа в подушечці — те, що вона робить.
...
* **знак не повідомляє результат замість тексту.** Стани знака описують процес
  (спокій · шукає · готово), а не висновок. «Сумної куниці» на порожній видачі
