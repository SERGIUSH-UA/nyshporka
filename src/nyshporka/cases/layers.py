...
нуля саме тут не можна. «1331 справа без декоду» виглядає як факт про
...
_CACHE: tuple[tuple[Any, ...], float, list[dict[str, Any]]] | None = None
_LAYERS: tuple[tuple[Any, ...], dict[str, dict[str, Any]]] | None = None
