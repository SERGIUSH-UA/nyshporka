...
# 🔴 Але не `None`: це вимикає захист для ВСЬОГО процесу (демон після першого
# ж виклику), а зображення архівів — недовірений вхід. Стеля 600 МП вкриває
# будь-який реальний розворот (A2 при 1200 dpi ≈ 450 МП) і лишає захист від
# файла, що розгортається в десятки гігабайт.
