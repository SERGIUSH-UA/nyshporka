...
class EngineProfile:
    ...
    #:
    #: 🔴 3.3 — вимір, а не компроміс: шард тримає свої 3.2-3.6 ГБ завжди (ваги
    #: обох рушіїв і буфери), і від щільності сторінки це майже не залежить.
    #: Менше означає арифметику, яка не сходиться; більше — гірший вибір
    #: машини, бо на цей поріг ділиться вільна пам'ять іще при доборі.
