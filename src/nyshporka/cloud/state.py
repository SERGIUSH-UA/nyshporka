...
class RunState:
    ...
    supervisor_plan: str = ""
    #: Інші справи ТОГО САМОГО заходу. Порожньо — захід на одну справу.
    #: 🔴 Не косметика: наглядач і машина в партії одні на всіх, тож згортання
    #: «цієї справи» згортає ВСЮ чергу. Не сказавши цього, ми дали б людині
    #: погасити чужу роботу, думаючи, що вона спиняє свою.
