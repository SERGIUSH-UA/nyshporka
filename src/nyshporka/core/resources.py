...
🔴 Скрипти теж тут, і це не формальність. `paths.ORCHESTRATOR` був рядком
`"scripts/spotter_v23_dino_case.py"`, який працював лише завдяки `cwd=ROOT` у
`create_subprocess_exec`. Тобто запуск субпроцесів мовчки залежав від того, що
