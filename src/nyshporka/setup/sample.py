...
**з готовим машинним декодом обома голосами**. Це навмисно: ваги качаються
окремо (`nysh models get`, ~130 МБ), і доти зразок уже показує весь ланцюг,
заради якого застосунок ставлять, — гортач із рамкою рядка, пошук у декоді,
реєстр справ, сховище прочитаного. Тобто перше враження не впирається ні в
закачку, ні в ніч обробки.
