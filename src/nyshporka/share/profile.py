...
class Profile:
    ...
    #:
    #: 🔴 Типово — НІ. Запит несе шифру й ключ, тобто сервер бачить, яку
    #: справу читає ця людина; `PRIVACY.md` обіцяє, що фонових запитів немає,
    #: доки людина сама їх не ввімкнула (`nysh share setup --lookup`).
    lookup: bool = False
